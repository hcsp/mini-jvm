...
public enum Opcode {
    ...
    // Constants
    nop(0x00, 0),
    aconst_null(0x01, 0),//将null加载到操作数栈
    iconst_m1(0x02, 0),
    iconst_0(0x03, 0),
    iconst_1(0x04, 0),
    ...
    dconst_0(0x0e, 0),
    dconst_1(0x0f, 0),
    bipush(0x10, 1),//将常量压入栈中
    sipush(0x11, 2),//将一个常量加载到操作数栈
    ldc(0x12, 1),//将一个常量加载到操作数栈
    ldc_w(0x13, 2),
    ldc2_w(0x14, 2),
    // Loads
    iload(0x15, 1),
    ...
    dload(0x18, 1),
    aload(0x19, 1),
    iload_0(0x1a, 0),//从当前栈帧局部变量表中0号位置取int类型的数值加载到操作数栈
    iload_1(0x1b, 0),//从当前栈帧局部变量表中1号位置取int类型的数值加载到操作数栈
    iload_2(0x1c, 0),
    iload_3(0x1d, 0),
    lload_0(0x1e, 0),
    lload_1(0x1f, 0),
    ...
    tableswitch(0xaa, 0),
    lookupswitch(0xab, 0),
    ireturn(0xac, 0),//返回int类型的数据,当返回值是boolean、byte、char、short和int时使用
    lreturn(0xad, 0),
    freturn(0xae, 0),
    dreturn(0xaf, 0),
    areturn(0xb0, 0),
    ...
    invokestatic(0xb8, 2),//用于调用类方法(static方法)
